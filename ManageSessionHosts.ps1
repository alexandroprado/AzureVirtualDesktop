...
Get-AzWvdSessionHost -ResourceGroupName AzureVirtualDesktop -HostPoolName Pooled | Select-Object Name,AllowNewSession

# Enable drain mode on the Session Host
Update-AzWvdSessionHost -ResourceGroupName AzureVirtualDesktop -HostPoolName Pooled -SessionHostName AVD-0 -AllowNewSession:$false
