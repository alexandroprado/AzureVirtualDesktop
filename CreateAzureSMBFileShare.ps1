...
#Define parameters
$SubscriptionId = "b5bbd729-c8a6-4ba0-9ba4-aa277fc0d1e3"
$ResourceGroupName = "AzureVirtualDesktop"
$StorageAccountName = "atsavdstorage"
...
Join-AzStorageAccountForAuth `
        ...
        -OrganizationalUnitDistinguishedName "OU=AVD,DC=AdamTechnology,DC=local" # If you don't provide the OU name as an input parameter, the AD identity that represents the storage account is created under the root directory.
