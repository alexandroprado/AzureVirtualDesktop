...
$gallery = Get-AzGallery -Name AVDImageGallery -ResourceGroupName AzureVirtualDesktop
...
Get-AzImage -ResourceGroupName AzureVirtualDesktop | Select-Object Name, ResourceGroupName
